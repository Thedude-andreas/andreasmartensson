...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function gc(){return new oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:va(),fragmentShader:`
		...
		`,blending:ii,depthTest:!1,depthWrite:!1})}function _c(){return new oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:va(),fragmentShader:`
...
`].filter(ps).join(`
`)),o=ea(o),o=Rc(o,e),o=Cc(o,e),a=ea(a),a=Rc(a,e),a=Cc(a,e),o=Pc(o),a=Pc(a),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
